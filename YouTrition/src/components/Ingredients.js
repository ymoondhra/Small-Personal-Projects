...
function scroller() {
    {
        ...
        $('.ingredient').each(function(index) {
            ...
            var spaceWidth = Math.abs(50*(scrolled2-top)/height);

            if(index % 2 == 1) {
                spaceWidth = Math.abs(50*(top-scrolled2)/height);
            }
            $(this).find('.ingredient-space').width(spaceWidth + '%');

            //opacity
            var opac = (100-(spaceWidth*2))/100;
            opac = opac*opac;
            $(this).find('.ingredient-description-container').css('opacity', opac);
        });
    }
}
    ...
    return(
        <div className="ingredient">
            ...
            <div className="ingredient-title flex">
                ...
                <div className="ingredient-name ingredient-effect">
                    {props.effect}
                </div>
            </div>
            <div className="ingredient-large-container flex">
                ...
                <div className="ingredient-description-container flex">
                    <div className="ingredient-description flex">
                        {props.description}
                    </div>
                </div>
            </div>
        ...
        return (
            <div className="page">
                ...
                <div className="ingredient-buy flex">
                    ...
                    <p> Which flavor was your favorite? <br />
